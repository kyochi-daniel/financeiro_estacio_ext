    ...
    <ThemedView enableScroll={false} style={styles.container}>
      ...
      {editing && (
        <View style={styles.editor}>
          <TextInput value={editing.quantity.toString()} onChangeText={(t) => setEditing({ ...editing, quantity: parseFloat(t) || 0 })} keyboardType="numeric" style={styles.input} />
          <TextInput value={editing.reorderThreshold.toString()} onChangeText={(t) => setEditing({ ...editing, reorderThreshold: parseFloat(t) || 0 })} keyboardType="numeric" style={styles.input} />
